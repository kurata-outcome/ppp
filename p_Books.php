...
<section class="text-bg-top bg-image wow animate__fadeIn" data-wow-duration="1s"
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h1 class="cover-txt txt-brown text-center mb-0">Books<span>書籍</span></h1>
			</div>
		</div>
	</div>
</section>
...
<section class="about-ppp section-padding wow animate__fadeIn" data-wow-duration="1s">
	<div class="container">
		<div class="section-border-title"> 
			<h2 class="txt-brown text-center font-34">カテゴリー<br><span class="font-36 font-bp-ic">Category</span></h2>
		</div>
...
?>
		...
		<div class="col-12 mt-4 text-center text-box">
			<p class="d-inline txt-lbrown font-22">本の内容に関するご質問は、各出版社にお問い合わせをお願いいたします。</p>
		</div>
	</div>
</section>
